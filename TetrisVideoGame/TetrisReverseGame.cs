...
{
	public class TetrisReverseGame : Form
	{
		...
		public TetrisReverseGame(int blockSize, int columns, int rows, string playername)
		{
		...
		public void init()
		{
			...
			//BGMplayer.PlayLooping(); //uncomment to turn on music
