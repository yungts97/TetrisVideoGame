...
namespace TetrisVideoGame
{
	public class HelpWindows:Form
	{
		...
		public HelpWindows()
		{
			...
			this.MaximumSize = new Size(830,650);

			title = new PictureBox();
            title.Image = Image.FromFile("help_center.png");
            ...
            downkey.BackColor = Color.Transparent;
            downkey.Width = 50;
			downkey.Height = 50;
			...
			down_des.ForeColor = Color.FromArgb(255, 233, 233);
            ...
            upkey.BackColor = Color.Transparent;
            upkey.Width = 50;
			upkey.Height = 50;
			upkey.Visible = true;
			upkey.Left = 75;
			...
			up_des.Visible = true;
			up_des.ForeColor = Color.FromArgb(255, 233, 233);
            ...
            leftkey.BackColor = Color.Transparent;
            leftkey.Width = 50;
			leftkey.Height = 50;
			...
			left_des.ForeColor = Color.FromArgb(255, 233, 233);
            ...
            rightkey.BackColor = Color.Transparent;
            rightkey.Width = 50;
			rightkey.Height = 50;
			...
			right_des.ForeColor = Color.FromArgb(255, 233, 233);
            ...
            shiftkey.BackColor = Color.Transparent;
            shiftkey.Width = 100;
			shiftkey.Height = 50;
			...
			shift_des.ForeColor = Color.FromArgb(255, 233, 233);
            ...
            zkey = new PictureBox();
            zkey.Image = Image.FromFile("keys/zkey.png");
            zkey.BackColor = Color.Transparent;
            zkey.SizeMode = PictureBoxSizeMode.StretchImage;
            zkey.Width = 50;
            zkey.Height = 50;
            zkey.Visible = true;
            zkey.Left = 75;
            zkey.Top = 510;
            this.Controls.Add(zkey);

            z_des = new Label();
            z_des.Text = "Right rotate";
            z_des.BackColor = Color.Transparent;
            z_des.Visible = true;
            z_des.ForeColor = Color.FromArgb(255, 233, 233);
            z_des.Font = new Font("Arial", 10, FontStyle.Bold);
            z_des.BringToFront();
            z_des.AutoSize = true;
            z_des.Left = 140;
            z_des.Top = 530;
            this.Controls.Add(z_des);

            spacekey = new PictureBox();
			spacekey.Image = Image.FromFile("keys/spacekey.png");
			spacekey.SizeMode = PictureBoxSizeMode.StretchImage;
            spacekey.BackColor = Color.Transparent;
            spacekey.Width = 160;
			spacekey.Height = 50;
			...
			space_des.ForeColor = Color.FromArgb(255, 233, 233);
            ...
            esckey.BackColor = Color.Transparent;
            esckey.Width = 50;
			esckey.Height = 50;
			esckey.Visible = true;
			esckey.Left = 425;
			...
			esc_des.ForeColor = Color.FromArgb(255, 233, 233);
            ...
            num1key.BackColor = Color.Transparent;
            num1key.Width = 50;
			num1key.Height = 50;
			...
			num1_des.ForeColor = Color.FromArgb(255, 233, 233);
            ...
            num2key.BackColor = Color.Transparent;
            num2key.Width = 50;
			num2key.Height = 50;
			...
			num2_des.ForeColor = Color.FromArgb(255, 233, 233);
            ...
            num3key.BackColor = Color.Transparent;
            num3key.Width = 50;
			num3key.Height = 50;
			...
			num3_des.ForeColor = Color.FromArgb(255, 233, 233);
            ...
            xkey = new PictureBox();
            xkey.Image = Image.FromFile("keys/xkey.png");
            xkey.SizeMode = PictureBoxSizeMode.StretchImage;
            xkey.BackColor = Color.Transparent;
            xkey.Width = 50;
            xkey.Height = 50;
            xkey.Visible = true;
            xkey.Left = 425;
            xkey.Top = 510;
            this.Controls.Add(xkey);

            x_des = new Label();
            x_des.Text = "Left rotate";
            x_des.BackColor = Color.Transparent;
            x_des.Visible = true;
            x_des.ForeColor = Color.FromArgb(255, 233, 233);
            x_des.Font = new Font("Arial", 10, FontStyle.Bold);
            x_des.BringToFront();
            x_des.AutoSize = true;
            x_des.Left = 490;
            x_des.Top = 530;
            this.Controls.Add(x_des);
