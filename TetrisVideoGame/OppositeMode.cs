...
{
	public class OppositeMode : Form
	{
		private OppositePlayFieldBoard _playboard;
		...
		private OppositeCollisionDetector _collisionDetector;
		...
		public OppositeMode(int blockSize, int columns, int rows, string playername)
		{
			...
			_playboard = new OppositePlayFieldBoard(this, blockSize, columns, rows, ColorDictionary);
			...
			_collisionDetector = new OppositeCollisionDetector();
		...
		public void init()
		{
            ...
            picGameMode.Width = 207;
            picGameMode.Height = 50;
            picGameMode.Top = 22;
            picGameMode.Left = 40;
            picGameMode.BackColor = Color.Transparent;
            picGameMode.Image = Image.FromFile("opposite.png");
            ...
            picInfo.Image = Image.FromFile("opposite_info.png");
