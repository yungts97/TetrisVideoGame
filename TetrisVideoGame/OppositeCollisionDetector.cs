...
{
    class OppositeCollisionDetector
    {
        public bool CheckCollision(Tetromino _tetromino, OppositePlayFieldBoard _playboard, int left_right, int down)
        {
        ...
        public int GetCollisionHeight(Tetromino _tetromino, OppositePlayFieldBoard _playboard)
        {
            int down = 0;
        ...
        public bool CheckRotationCollision(Tetromino _tetromino, OppositePlayFieldBoard _playboard)
        {
            for (int i = 0; i < _tetromino.Height; ++i)
            {
                for (int j = 0; j < _tetromino.Width; ++j)
