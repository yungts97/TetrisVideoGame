...
{
	public class Self_rotate_mode : Form
	{
		...
		private Timer TetrominoRotateTimer;
		...
		public Self_rotate_mode(int blockSize, int columns, int rows, string playername)
		{
		...
		public void init()
		{
            ...
            picGameMode.Width = 288;
            picGameMode.Height = 50;
            picGameMode.Top = 22;
            picGameMode.Left = 40;
            picGameMode.BackColor = Color.Transparent;
            picGameMode.Image = Image.FromFile("self_rotate.png");
            ...
            picInfo.Image = Image.FromFile("self_rotate_info.png");
			...
			TetrominoRotateTimer = new Timer();
			TetrominoRotateTimer.Tick += new EventHandler(this.TetrominoRoate_Tick);
			TetrominoRotateTimer.Interval = 500;
			TetrominoRotateTimer.Enabled = true;
		}
        ...
        private void picPause_OnClick(object sender, EventArgs e)
        {
            ...
            TetrominoRotateTimer.Enabled = false;
            while (true)
            {
		...
		private void TetrominoRoate_Tick(object sender, EventArgs e)
		{
			_playboard.RemoveShape(_tetromino);
